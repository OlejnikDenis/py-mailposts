...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 901, 689))
        ...
        self.L_IndexTitle = QtWidgets.QLabel(self.horizontalLayoutWidget)
        ...
        self.comboBox_Index = QtWidgets.QComboBox(self.horizontalLayoutWidget)
        ...
        self.Horizintal_Line_TOP = QtWidgets.QFrame(self.horizontalLayoutWidget)
        ...
        self.L_CityNameTitle_2 = QtWidgets.QLabel(self.horizontalLayoutWidget)
        self.L_CityNameTitle_2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.L_CityNameTitle_2.setObjectName("L_CityNameTitle_2")
        self.VBox_EditButtons.addWidget(self.L_CityNameTitle_2)
        ...
        self.Horizintal_Line_TOP_2 = QtWidgets.QFrame(self.horizontalLayoutWidget)
        self.Horizintal_Line_TOP_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.Horizintal_Line_TOP_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.Horizintal_Line_TOP_2.setObjectName("Horizintal_Line_TOP_2")
        self.VBox_Filters.addWidget(self.Horizintal_Line_TOP_2)
        ...
        self.LE_Stats_UniqueSubjects = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        ...
        self.LE_Stats_Mailposts = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        ...
        self.LE_Stats_Customers = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        ...
        self.LE_Stats_Cities = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        ...
        self.LE_Stats_AvgCustomers = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        ...
        self.Vertical_Line = QtWidgets.QFrame(self.horizontalLayoutWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.L_CityNameTitle_2.setText(_translate("MainWindow", "Редактирование данных"))
        self.pushButton_RowAdd.setText(_translate("MainWindow", "ADD"))
        self.pushButton_RowEdit.setText(_translate("MainWindow", "EDIT"))
        self.pushButton_RowDel.setText(_translate("MainWindow", "DEL"))
